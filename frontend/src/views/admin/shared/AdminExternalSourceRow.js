...
//const CLASS_NAME = "AdminExternalSourceRow";

function AdminExternalSourceRow(props) { //props are item, showActions
        ...
        <>
            <tr className={`mx-0 my-1 p-0 py-1 ${cssClass}`}>
                <td className="py-2 pl-2 align-middle" >
                    <a className="btn btn-icon-outline circle mr-2" href={`/admin/externalsource/${props.item.id}`} ><i className="material-icons">edit</i></a>
                </td>
...
export default AdminExternalSourceRow;