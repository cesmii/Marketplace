...
namespace CESMII.Marketplace.RestApi
{
    public class TestSuite_MarketplaceAPI
    {
        ...
        {
            string strHostHttps = "http://CESMII.Marketplace.API/api";
        ...
        {
            string strHostHttps = "https://CESMII.Marketplace.API/api";
            HttpClient client = new HttpClient();
        ...
        {
            string strHostHttps = "http://CESMII.Marketplace.API:5000/api";
            HttpClient client = new HttpClient();
        ...
        {
            string strHostHttps = "https://CESMII.Marketplace.API:5001/api";
            HttpClient client = new HttpClient();
